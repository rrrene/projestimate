  ...
  def create
    ...
    respond_to do |format|
      if @admin_setting.save
        format.html { redirect_to admin_settings_path, notice: 'Admin setting was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @admin_setting.update_attributes(params[:admin_setting])
        format.html { redirect_to admin_settings_path, notice: 'Admin setting was successfully updated.' }
        format.json { head :ok }
      else
