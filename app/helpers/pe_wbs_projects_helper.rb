  ...
  ##========================================== FOR WBS PRODUCT ======================================================##
    ...
    def wbs_navigation_links(c)
      "<li class='#{ c.id == current_component.id ? "selected_pbs" : '' }' >
        ...
        <div class='block_link'>
          #{ link_to "", edit_pbs_project_element_path(c, :project_id => @project.id), :remote => true, :class => 'bl icon-edit icon-large icon-border' if can? :edit_a_pbs_project_element, PbsProjectElement}
          #{ link_to "", c, confirm: I18n.t('are_you_sur'), method: :delete, :remote => true, :class => 'bl icon-trash icon-large icon-border' if can? :delete_a_pbs_project_element, PbsProjectElement}
    ...
    def wbs_root_links(pbs_project_element, project)
      "<li class='#{ pbs_project_element.id == current_component.id ? 'selected_pbs' : '' }'>
        ...
        <div class='block_link'>
          #{ link_to "", edit_pbs_project_element_path(pbs_project_element, :project_id => @project.id), :remote => true, :class => 'bl icon-edit icon-large icon-border' if can? :edit_a_pbs_project_element, PbsProjectElement }
