    ...
    def wbs_folder_links(c, project)
      "<li class='#{ c.id == current_component.id ? 'selected' : '' }' >
        ...
        <div class='block_link'>
          ...
          #{ link_to "", { :controller => 'pbs_project_elements', :action => 'new', :pe_wbs_project_id => project.pe_wbs_projects.products_wbs.first.id, :comp_parent_id => c.id, :type_component => "folder" }, :remote => true, :class => 'bl icon-folder-open icon-large'}
          #{ link_to "", { :controller => 'pbs_project_elements', :action => 'new', :pe_wbs_project_id => project.pe_wbs_projects.products_wbs.first.id, :comp_parent_id => c.id, :type_component => "undefined" },:remote => true, :class => 'bl icon-plus icon-large ' }
          #{ link_to "", { :controller => 'pbs_project_elements', :action => 'new', :pe_wbs_project_id => project.pe_wbs_projects.products_wbs.first.id, :comp_parent_id => c.id, :type_component => "link" }, :remote => true, :class => 'bl icon-link icon-large '}
    ...
    def wbs_root_links(pbs_project_element, project)
      "<li class='#{ pbs_project_element.id == (current_component.nil? ? nil : current_component.id) ? 'selected' : '' }'>
        ...
        <div class='block_link'>
          ...
          #{ link_to("", { :controller => 'pbs_project_elements', :action => 'new', :pe_wbs_project_id => project.pe_wbs_projects.products_wbs.first.id, :comp_parent_id => pbs_project_element.id, :type_component => "folder" }, :remote => true, :class => 'bl icon-folder-open icon-large') }
          #{ link_to "", { :controller => 'pbs_project_elements', :action => 'new', :pe_wbs_project_id => project.pe_wbs_projects.products_wbs.first.id, :comp_parent_id => pbs_project_element.id, :type_component => "undefined" }, :remote => true, :class => 'bl icon-plus icon-large ' }
          #{ link_to "", { :controller => 'pbs_project_elements', :action => 'new', :pe_wbs_project_id => project.pe_wbs_projects.products_wbs.first.id, :comp_parent_id => pbs_project_element.id, :type_component => "link" }, :remote => true, :class => 'bl icon-link icon-large ' }
        </div>
      </li>"
    end
end
