...
module PeWbsProjectsHelper
  ...
  def wbs_folder_links(c, project, is_project_show_view)
    "<li class='' >
        ...
        <div class='block_link'>
          #{ link_to "", edit_pbs_project_element_path(c, :project_id => @project.id), :remote => true, :class => 'button_attribute_tooltip icon-edit icon-large icon-border', :title => I18n.t('edit') unless is_project_show_view }
          #{ link_to "", new_pbs_project_element_path(:project_id => @project.id, :parent_id => c.id), :remote => true, :class => 'button_attribute_tooltip icon-folder-open icon-large icon-border', :title => I18n.t('add_folder') unless is_project_show_view }
          #{ link_to "", new_pbs_project_element_path(:project_id => @project.id, :parent_id => c.id), :remote => true, :class => 'button_attribute_tooltip icon-plus icon-large icon-border', :title => I18n.t('add_component') unless is_project_show_view }
          #{ link_to "", new_pbs_project_element_path(:project_id => @project.id, :parent_id => c.id), :remote => true, :class => 'button_attribute_tooltip icon-link icon-large icon-border', :title => I18n.t('add_link') unless is_project_show_view }
  ...
  def wbs_root_links(pbs_project_element, project, is_project_show_view)
    "<li class=''>
        ...
        <div class='block_link'>
          ...
          #{ link_to("", new_pbs_project_element_path(:project_id => @project.id, :work_element_type => "folder", :parent_id => pbs_project_element.id), :remote => true, :class => 'button_attribute_tooltip icon-folder-open icon-large icon-border', :title => I18n.t('add_folder')) unless is_project_show_view }
          #{ link_to "", new_pbs_project_element_path(:project_id => @project.id, :work_element_type => "component", :parent_id => pbs_project_element.id), :remote => true, :class => 'button_attribute_tooltip icon-plus icon-large icon-border', :title => I18n.t('add_component') unless is_project_show_view }
          #{ link_to "", new_pbs_project_element_path(:project_id => @project.id, :work_element_type => "link", :parent_id => pbs_project_element.id), :remote => true, :class => 'button_attribute_tooltip icon-link icon-large icon-border', :title => I18n.t('add_link') unless is_project_show_view }
        </div>
      </li>"
  end
end
