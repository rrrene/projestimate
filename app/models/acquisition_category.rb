...
class AcquisitionCategory < ActiveRecord::Base
  ...
  has_one    :child,  :class_name => "AcquisitionCategory", :inverse_of => :parent, :foreign_key => "parent_id"
  belongs_to :parent, :class_name => "AcquisitionCategory", :inverse_of => :child,  :foreign_key => "parent_id"
