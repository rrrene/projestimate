...
class ActivityCategory < ActiveRecord::Base
  ...
  has_one    :child_reference,  :class_name => "ActivityCategory", :inverse_of => :parent_reference, :foreign_key => "reference_id"
  belongs_to :parent_reference, :class_name => "ActivityCategory", :inverse_of => :child_reference,  :foreign_key => "reference_id"
