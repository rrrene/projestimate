...
describe SearchesHelper do
  ...
  it "should display link" do
    display_link(@ksloc_attribute, "toto").should == "<a href=\"/pe_attributes/#{@ksloc_attribute.id}/edit\" class=\"search_result\ style=\"font-size:12px; color: #467aa7;\">Ksloc1 - Attribut number 1</a>"
  end
