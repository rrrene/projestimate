...
describe LanguagesController do
  ...
  describe "GET index" do
    before do
      ...
      user_groups = mock_model(Group, :for_global_permission => true, :permissions => [group_permission_1, group_permission_2, group_permission_3, group_permission_4, group_permission_5, group_permission_6])
      user_language = mock_model(Language, :name => "English", :locale => "en")

      @user = mock_model(User, :language => user_language, :groups => [user_groups], :group_for_global_permissions => [user_groups])
  ...
  #    test = FactoryGirl.create(:language, :name => "Breton", :locale => "br")
  #    @ability.can :create, Language
  #
  ...
  #    @ability.stub!(:can?).with(:destroy, @language).and_return(true)
  #    #@ability.can?(:destroy, @language)
  #
  #
  #    #test = Language.stub(:create).and_return(@language)
  #    #@params = { :id => @language.id }
  #    @params = { :id => @language.id }
  #
  #    delete :destroy, @params
