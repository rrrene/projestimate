...
#        post :create, {:version => { "local_latest_update" => "invalid value" }}, valid_session
#        assigns(:version).should be_a_new(Version)
#      end
#
...
#        Version.any_instance.should_receive(:update_attributes).with({ "local_latest_update" => "2013-03-19 14:28:31" })
#        put :update, {:id => version.to_param, :version => { "local_latest_update" => "2013-03-19 14:28:31" }}, valid_session
#      end
#
#      it "assigns the requested version as @version" do
#        version = Version.create! valid_attributes
...
#        # Trigger the behavior that occurs when invalid params are submitted
#        Version.any_instance.stub(:save).and_return(false)
#        put :update, {:id => version.to_param, :version => { "local_latest_update" => "invalid value" }}, valid_session
#        assigns(:version).should eq(version)
#      end
#
